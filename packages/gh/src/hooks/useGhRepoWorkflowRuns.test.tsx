...
describe('useGhRepoWorkflowRuns', () => {
  it('returns data on success', async () => {
    ...
    const { result } = renderHook(() => useGhRepoWorkflowRuns('octocat', 'Hello-World'), { wrapper });
  ...
  it('passes params to the client', async () => {
    ...
    const { result } = renderHook(() => useGhRepoWorkflowRuns('octocat', 'Hello-World', params), { wrapper });
    await waitFor(() => expect(result.current.isLoading).toBe(false));
